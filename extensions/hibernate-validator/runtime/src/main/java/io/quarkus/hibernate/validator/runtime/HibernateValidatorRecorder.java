...
public class HibernateValidatorRecorder {
    ...
    public RuntimeValue<ValidatorFactory> initializeValidatorFactory(Set<Class<?>> classesToBeValidated,
        ...
        return new RuntimeValue<>(configuration.buildValidatorFactory());
    }
    ...
    public static class ValidatorFactoryDestroyer implements BeanDestroyer<ValidatorFactory> {
