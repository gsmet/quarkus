...
The solution is located in the `spring-di-quickstart` link:{quickstarts-tree-url}/spring-di-quickstart[directory].
...
:create-app-extensions: rest,spring-di
...
include::{generated-dir}/config/quarkus-spring-di.adoc[leveloffset=+1, opts=optional]
