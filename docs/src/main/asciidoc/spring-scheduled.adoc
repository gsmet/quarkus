...
The solution is located in the `spring-scheduled-quickstart` link:{quickstarts-tree-url}/spring-scheduled-quickstart[directory].
...
:create-app-extensions: rest,spring-scheduled
