...
The solution is located in the `spring-security-quickstart` link:{quickstarts-tree-url}/spring-security-quickstart[directory].
...
:create-app-extensions: spring-web,spring-security,quarkus-elytron-security-properties-file,rest-jackson
:create-app-code:
...
:add-extension-extensions: spring-web,spring-security,quarkus-elytron-security-properties-file,rest-jackson
