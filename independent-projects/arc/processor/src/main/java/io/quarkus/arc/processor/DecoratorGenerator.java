    ...
    private void generateDecorator(Gizmo gizmo, DecoratorInfo decorator, String generatedName, String baseName,
        ...
        gizmo.class_(generatedName, cc -> {
            ...
            if (decorator.hasDestroyLogic()) {
                // TODO original code passes an empty map instead of `injectionPointToProviderField`?
                generateDestroy(cc, decorator, injectionPointToProviderField, isApplicationClass, baseName, targetPackage);
            }
