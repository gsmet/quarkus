...
public class InvokerGenerator extends AbstractGenerator {
                            ...
                            if (argumentSuppliers[i] != null) {
                                ...
                                if (resolved.isUserBean()) {
                                    ...
                                    builtinBean.getGenerator_2().generate(new GeneratorContext_2(beanDeployment,
                                            injectionPoint, argumentSuppliers[i].name(), annotationLiterals, invoker,
    ...
    private static void unboxAndWiden(BlockCreator b0, Var value, Var target, PrimitiveType targetType, int argumentNumber) {
        ...
        for (ClassType possibleType : WIDENING_CONVERSIONS_TO.get(targetType)) {
        ...
        b0.ifNot(ok, b1 -> {
            b1.throw_(ClassCastException.class, b1.withNewStringBuilder()
